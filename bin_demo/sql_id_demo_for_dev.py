...
def warn_if_using_bundled_domain_salt() -> None:
    ...
    if WARNED_BUNDLED_DOMAIN_SALT or DOMAIN_SALT_HEX != BUNDLED_DOMAIN_SALT_HEX:
        return
    ...
    print(
        ...
        "print(secrets.token_hex(32))'. This demo sets "
        f"{DEMO_ALLOW_BUNDLED_DOMAIN_SALT_ENV}=1 so sample IDs can be generated.",
        file=sys.stderr,
    )
